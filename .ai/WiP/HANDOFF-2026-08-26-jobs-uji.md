...
Orchestrator still owes: register the three connectors in `connectors/__init__.py::CONNECTOR_MODULES` and `enums.PLATFORMS`, then `make contracts`, run the gate, commit per path, push.
