...
- [ ] workflow follow-ups: `start_workflow` assistant tool; ARQ-backed steps + scheduled starts (daily follow-up sweep); a `send` gate once Gmail exists; bot buttons for pending gates
