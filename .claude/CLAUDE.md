...
5. No scraping, no platform passwords/cookies, no auto-apply/auto-send. External writes need an approved `Action`. OAuth tokens (user-granted, revocable) are allowed and live only in the 0600 token file / env (ADR-013).
